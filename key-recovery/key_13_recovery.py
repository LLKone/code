...
def run(n, nr=13, num_structures=10000000, it=500, cutoff1=10.0, cutoff2=10.0, neutral_bits=[[20],[22],[13],[12,19],[14,21],[6,29]], keyschedule='real',net=net8, net_help=net7, m_main=m8, s_main=s8,  m_help=m7, s_help=s7, verify_breadth=None):
...
folder='./'
# 写文件 'wb'：以二进制写模式打开文件
np.save(folder + 'run_sols1_13round.npy', arr1)
np.save(folder + 'run_sols2_13round.npy', arr2)
np.save(folder + 'run_good_13round.npy', good)
np.save(open('run_sols13.npy','wb'),arr1);
np.save(open('run_sols23.npy','wb'),arr2);
np.save(open('run_good13.npy','wb'),good);
